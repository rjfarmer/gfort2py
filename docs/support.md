...
These platforms are fully supported and all features should work. We test for all combinations of supported Python (>=3.10) and gfortran (>=8) versions when available on the platform.
