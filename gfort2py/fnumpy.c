...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            ...
            "/usr/lib64/python3.5/site-packages/numpy/core/include/numpy/ndarraytypes.h",
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initfnumpy(void); /*proto*/
PyMODINIT_FUNC initfnumpy(void)
#else
PyMODINIT_FUNC PyInit_fnumpy(void); /*proto*/
PyMODINIT_FUNC PyInit_fnumpy(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_fnumpy(void)", 0);
